        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RawMaterials_Colors_ColorId",
                        column: x => x.ColorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryRawMaterials", x => new { x.RawMaterialId, x.InventoryId });
                    table.ForeignKey(
                        name: "FK_InventoryRawMaterials_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryRawMaterials_RawMaterials_RawMaterialId",
